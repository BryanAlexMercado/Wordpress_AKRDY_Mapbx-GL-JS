...
define( __NAMESPACE__ . '\PLUGIN_VERSION', '1.13.1' );
...
} catch ( Exceptions\IsNotSupportedWordPressVersion $e ) {
	Plugin::renderOutdatedWordPressVersionNotice();
} catch ( \Exception $e ) {
	// phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_trigger_error
