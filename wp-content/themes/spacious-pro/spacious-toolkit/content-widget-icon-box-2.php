<?php
/**
 * The template for displaying Icon Box 2 widget.
 *
 * This template can be overridden by copying it to yourtheme/spacious-toolkit/content-widget-icon-box-2.php.
 *
