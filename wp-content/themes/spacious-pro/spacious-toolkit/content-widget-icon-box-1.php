<?php
/**
 * The template for displaying Icon Box 1 widget.
 *
 * This template can be overridden by copying it to yourtheme/spacious-toolkit/content-widget-icon-box-1.php.
 *
 ...
 * @version 1.0.0
 *
 * @var $instance SPT_ICON_BOX_1
 */

use Elementor\SPT_ICON_BOX_1;
...
<div class="icon-box icon-box--rounded">
	<?php if ( ! empty( $icon ) ) : ?>
