<?php
/**
 * The template for displaying Testimonial 2 widget.
 *
 * This template can be overridden by copying it to yourtheme/spacious-toolkit/content-widget-testimonial-2.php.
 *
...
<div class="testimonial testimonial-style-three">
