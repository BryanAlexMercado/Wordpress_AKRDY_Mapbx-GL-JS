<?php
/**
 * The template for displaying Pricing table 3 widget.
 *
 * This template can be overridden by copying it to yourtheme/spacious-toolkit/content-widget-pricing-table-3.php.
 *
 ...
 * @version 1.0.0
 *
 * @var $instance SPT_PRICING_TABLE_3
 */

use Elementor\SPT_PRICING_TABLE_3;
...
<div class="pricing-table pricing-table-style-three">
