<?php
/**
 * Icon Box 4 Widget controls
 *
 * This template can be overridden by copying it to yourtheme/spacious-toolkit/controls/content-widget-icon-box-4.php.
 *
 ...
 * @author   ThemeGrill
 *
 * @var $instance SPT_ICON_BOX_4
 */

use Elementor\SPT_ICON_BOX_4;
