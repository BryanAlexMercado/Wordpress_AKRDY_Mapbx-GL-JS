<?php
/**
 * Pricing Table 4 Widget controls
 *
 * This template can be overridden by copying it to yourtheme/spacious-toolkit/controls/content-widget-pricing-table-4.php.
 *
