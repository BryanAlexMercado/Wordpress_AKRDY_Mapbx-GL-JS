 ...
 *
 * This template can be overridden by copying it to yourtheme/spacious-toolkit/preview/content-widget-pricing-table-3.php.
 *
...
<div class="pricing-table pricing-table-style-three">
	...
	<footer class="pricing-table__footer">
		<a href="{{{ settings.button_link.url }}}" {{{ target }}} {{{ nofollow }}}
		   class="btn btn--black elementor-inline-editing"
