<?php
/**
 * COUNTER 3 Widget controls
 *
 * This template can be overridden by copying it to yourtheme/spacious-toolkit/preview/content-widget-counter-3.php.
 *
...
<div class="counter counter-style-three">
	...
	<div class="counter__number"
	     ...
	     data-refresh-interval="{{{ settings.interval }}}">
		{{{ settings.starting_number }}}
	</div>
	<# }

	if ( settings.title ) { #>
	<span class="counter__title">{{{ settings.title }}}</span>
	<# } #>
</div> <!-- .counter -->