 ...
 *
 * This template can be overridden by copying it to yourtheme/spacious-toolkit/preview/content-widget-team-3.php.
 *
...
<div class="team-member team-style-three">
	...
	<div class="team-member__info">
		...
		<ul class="social-icons social-icons--background">
			...
			if ( social_url ) { #>
			<li><a href="{{ social_link.url }}" {{ target }} {{ nofollow }}><i
							class="fa fa-{{ social.replace( '_', '-' ) }}"></i></a></li>
			<# } #>
			<# }); #>
		</ul>
