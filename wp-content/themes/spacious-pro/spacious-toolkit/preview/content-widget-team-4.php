 ...
 *
 * This template can be overridden by copying it to yourtheme/spacious-toolkit/preview/content-widget-team-4.php.
 *
...
<div class="team-member team-style-four">
	...
	<ul class="social-icons social-icons--border">
		<#
		var socials = [ 'facebook', 'twitter', 'instagram', 'pinterest_p' ];
		...
		if ( social_url ) { #>
		<li>
			<a href="{{ social_link.url }}" {{ target }} {{ nofollow }}>
