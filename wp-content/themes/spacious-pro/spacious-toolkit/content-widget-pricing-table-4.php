<?php
/**
 * The template for displaying Pricing table 4 widget.
 *
 * This template can be overridden by copying it to yourtheme/spacious-toolkit/content-widget-pricing-table-4.php.
 *
 ...
 * @version 1.0.0
 *
 * @var $instance SPT_PRICING_TABLE_4
 */

use Elementor\SPT_PRICING_TABLE_4;
...
<div class="pricing-table pricing-table-style-four">
