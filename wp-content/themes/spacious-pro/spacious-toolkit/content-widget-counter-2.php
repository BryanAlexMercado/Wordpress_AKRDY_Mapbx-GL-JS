<?php
/**
 * The template for displaying Counter 2 widget.
 *
 * This template can be overridden by copying it to yourtheme/spacious-toolkit/content-widget-counter-2.php.
 *
...
<div class="counter counter-style-two">
	<?php if ( ! empty( $icon ) ) : ?>
