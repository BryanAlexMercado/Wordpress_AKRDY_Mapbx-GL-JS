<?php
/**
 * The template for displaying Counter 3 widget.
 *
 * This template can be overridden by copying it to yourtheme/spacious-toolkit/content-widget-counter-3.php.
 *
 ...
 * @version 1.0.0
 *
 * @var $instance SPT_COUNTER_3
 */

use Elementor\SPT_COUNTER_3;
...
$speed           = $instance->get_settings( 'speed' );
$interval        = $instance->get_settings( 'interval' );
$title           = $instance->get_settings( 'title' );

$instance->add_render_attribute( 'title', 'class', 'counter__title' );
?>

<div class="counter counter-style-three">
	<?php if ( ! empty( $icon ) ) : ?>
	...
	<?php if ( ! empty( $ending_number ) ) : ?>
		<div class="counter__number"
		     ...
		     data-speed="<?php echo absint( $speed ); ?>"
		     data-refresh-interval="<?php echo absint( $interval ); ?>">
