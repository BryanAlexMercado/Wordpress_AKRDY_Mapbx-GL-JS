...
if ( class_exists( 'Iconic_CFFV_Core_Autoloader' ) ) {
	return;
}

/**
 * Iconic_CFFV_Core_Autoloader.
 *
 * @class    Iconic_CFFV_Core_Autoloader
 * @version  1.0.1
 * @category Class
 * @author   Iconic
 */
class Iconic_CFFV_Core_Autoloader {
	/**
	 * Single instance of the Iconic_CFFV_Core_Autoloader object.
	 *
	 * @var Iconic_CFFV_Core_Autoloader
	 */
	...
	/**
	 * Creates/returns the single instance Iconic_CFFV_Core_Autoloader object.
	 *
	 * @return Iconic_CFFV_Core_Autoloader
	 */
