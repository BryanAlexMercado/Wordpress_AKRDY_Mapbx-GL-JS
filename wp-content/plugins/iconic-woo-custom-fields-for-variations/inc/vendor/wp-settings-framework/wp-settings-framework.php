...
if ( ! class_exists( 'Iconic_CFFV_Settings_Framework' ) ) {
	/**
	 * Iconic_CFFV_Settings_Framework class
	 */
	class Iconic_CFFV_Settings_Framework {
		/**
		 * @access private
		 * @var array
		 */
		...
		/**
		 * Iconic_CFFV_Settings_Framework constructor.
		 *
