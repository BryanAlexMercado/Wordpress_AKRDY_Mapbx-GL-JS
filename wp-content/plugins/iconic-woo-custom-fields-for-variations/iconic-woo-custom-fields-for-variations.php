...
class Iconic_CFFV {
	 ...
	 * @since  1.0.0
	 * @access public
	 * @var Iconic_CFFV_Post_Types $post_types
	 */
	public $post_types;
	 ...
	 * @since  1.0.0
	 * @access public
	 * @var Iconic_CFFV_Meta_Boxes $meta_boxes
	 */
	public $meta_boxes;
	...
	public function add_post_types() {
		$this->post_types = new Iconic_CFFV_Post_Types();
	...
	public function add_meta_boxes() {
		$this->meta_boxes = new Iconic_CFFV_Meta_Boxes();
