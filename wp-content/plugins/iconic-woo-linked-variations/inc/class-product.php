...
class Iconic_WLV_Product {
			...
			foreach ( $linked_variations_data['attributes'] as $taxonomy => $attribute_data ) { ?>
				...
				<tr class="iconic-wlv-variations__row iconic-wlv-variations__row--<?php echo esc_attr( $taxonomy ); ?>">
					<td class="label iconic-wlv-variations__label">
						...
						<span class="iconic-wlv-variations__selection" data-iconic-wlv-selected-term-label="<?php echo esc_attr( $current_label ); ?>"><?php echo $current_label; ?></span>
					</td>
	...
	public static function output_values_dropdown( $attribute_data, $taxonomy = '' ) {
		...
		<select id="test" class="iconic-wlv-terms iconic-wlv-terms--dropdown" onchange="this.options[this.selectedIndex].value && (window.location.href !== this.options[this.selectedIndex].value) && (window.location = this.options[this.selectedIndex].value);">
	...
	public static function is_value_allowed( $term_data ) {
		...
		if ( ! empty( $term_data['linked_variation_data']['variation'] ) ) {
			if ( $term_data['linked_variation_data']['variation']['stock_status'] !== 'instock' && 'yes' === get_option( 'woocommerce_hide_out_of_stock_items' ) ) {
				return false;
			}
		}
