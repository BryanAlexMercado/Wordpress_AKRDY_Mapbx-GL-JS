...
if ( ! class_exists( 'Iconic_WLV_Settings_Framework' ) ) {
	/**
	 * Iconic_WLV_Settings_Framework class
	 */
	class Iconic_WLV_Settings_Framework {
		/**
		 * @access private
		 * @var array
		 */
		...
		/**
		 * Iconic_WLV_Settings_Framework constructor.
		 *
