...
if ( class_exists( 'Iconic_WLV_Core_Cross_Sells' ) ) {
	return;
}

/**
 * Iconic_WLV_Core_Cross_Sells.
 *
 * @class    Iconic_WLV_Core_Cross_Sells
 * @version  1.0.0
 */
class Iconic_WLV_Core_Cross_Sells {
	/**
	 * Single instance of the Iconic_WLV_Core_Licence object.
	 *
	 * @var Iconic_WLV_Core_Licence
	 */
	...
	/**
	 * Creates/returns the single instance Iconic_WLV_Core_Licence object.
	 *
	 * @param array $args Arguments.
	 *
	 * @return Iconic_WLV_Core_Licence
	 */
	...
	/**
	 * Iconic_WLV_Core_Cross_Sells constructor.
	 */
	...
	private static function get_plugins() {
		return array(
			'iconic-woo-show-single-variations'       => array(
				...
				'description' => __( 'Display individual product variations of a variable product in your product listings. Make it easy for your customers to view and filter product variations.', 'iconic-wlv' ),
			...
			'iconic-woothumbs'                        => array(
				...
				'description' => __( 'Enable zoom, sliders, video, fullscreen, multiple images per variation, and customisable layout options for your product imagery.', 'iconic-wlv' ),
			...
			'iconic-woo-delivery-slots'               => array(
				...
				'description' => __( 'Choose a delivery date and time for each order. Add a limit to the number of allowed reservations, restrict time slots to specific delivery methods, and so much more.', 'iconic-wlv' ),
			...
			'iconic-woo-linked-variations'            => array(
				...
				'description' => __( 'Link a group of WooCommerce products together by their attributes; a new way to handle product variations.', 'iconic-wlv' ),
			...
			'iconic-woo-product-configurator'         => array(
				...
				'description' => __( 'Use transparent image layers for your variable products, removing the need to create hundreds of final product variation images.', 'iconic-wlv' ),
			...
			'iconic-woo-quicktray'                    => array(
				...
				'description' => __( 'A modern take on quick view for WooCommerce; expand product details within your product listings for a convenient shopping experience.', 'iconic-wlv' ),
			...
			'iconic-woo-account-pages'                => array(
				...
				'description' => __( 'Add and manage pages in your WooCommerce "My Account" area using the native WordPress "Pages" functionality.', 'iconic-wlv' ),
			...
			'iconic-woo-quickview'                    => array(
				...
				'description' => __( 'Quickly view any product from the catalog, without reloading the page. Encourage sales with easy and efficient product browsing.', 'iconic-wlv' ),
			...
			'iconic-woo-attribute-swatches'           => array(
				...
				'description' => __( 'Bored of the standard dropdown fields when viewing a variable product? Turn them into colour, image, or text swatches!', 'iconic-wlv' ),
			...
			'iconic-woo-custom-fields-for-variations' => array(
				...
				'description' => __( 'Easily add custom fields to your product variations; the perfect way to display organised additional product data to your customers.', 'iconic-wlv' ),
			...
			'iconic-woo-bundled-products'             => array(
				...
				'description' => __( 'Bundle a selection of products on a single product page. It even works with variable products!', 'iconic-wlv' ),
			...
			'iconic-woo-sales-booster'                => array(
				...
				'description' => __( 'Use proven cross-selling techniques to increase the average order value of your store.', 'iconic-wlv' ),
			...
			'flux-checkout'                           => array(
				...
				'description' => __( 'Prevent abandoned carts with a slick multi-step checkout experience, designed for your customer’s device.', 'iconic-wlv' ),
	...
	public static function get_output() {
		...
		$utm = '?utm_source=Iconic&utm_medium=Plugin&utm_campaign=iconic-wlv&utm_content=cross-sell';
		...
		<div class="iconic-cross-sells-wrapper">
			<div class="iconic-cross-sells-columns iconic-cross-sells-columns--plugins">
							...
							<div class="iconic-cross-sell__border">
								...
								<div class="iconic-cross-sell__footer">
									<a class="iconic-cross-sell__link button-secondary" href="<?php echo esc_attr( $cross_sell['url'] . $utm ); ?>" target="_blank">
										<?php echo esc_html( __( 'Learn More', 'iconic-wlv' ) ); ?>
				...
				<a href="https://iconicwp.com/products/<?php echo esc_url( $utm ); ?>" class="button-secondary"><?php echo esc_html( __( 'View All Iconic Plugins', 'iconic-wlv' ) ); ?></a>
			</div>

			<div class="iconic-cross-sells-columns iconic-cross-sells-columns--testimonials">
				<p class="iconic-trust">
					<span class="dashicons dashicons-thumbs-up"></span> <?php echo esc_html( __( 'Trusted by over 10,000 WooCommerce Businesses and Online Shops', 'iconic-wlv' ) ); ?>
				</p>
				<?php foreach ( self::$selected_plugins as $cross_sell ) { ?>
					<?php
